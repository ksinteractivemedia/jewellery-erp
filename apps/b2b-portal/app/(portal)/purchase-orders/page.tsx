...
export default function PurchaseOrdersPage() {
  ...
  return (
    <>
      <PageHead title="Purchase orders" sub="Every order you’ve sent us, from draft to approval." actions={<Link href="/quick-order" className="btn btn-primary">New order</Link>} />
