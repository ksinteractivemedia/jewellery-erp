...
export const PERMISSION_DESCRIPTIONS: Record<PermissionKey, string> = {
  ...
  [PERMISSIONS.EXCHANGE_CREATE]: "Take in and assess an exchange",
  [PERMISSIONS.EXCHANGE_APPROVE]: "Complete an exchange — commits the assessed valuation to inventory and settlement",
