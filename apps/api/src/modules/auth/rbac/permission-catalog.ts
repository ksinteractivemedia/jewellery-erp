...
export const PERMISSION_DESCRIPTIONS: Record<PermissionKey, string> = {
  ...
  [PERMISSIONS.PURCHASING_CREATE]: "Raise supplier purchase orders and goods receipts",
  [PERMISSIONS.PURCHASING_APPROVE]: "Approve supplier purchase orders",
  ...
  [PERMISSIONS.ACCOUNTING_VIEW]: "View invoices, payments and outstanding balances",
