...
export const DEFAULT_ROLE_MATRIX: Record<RoleName, PermissionKey[]> = {
  ...
  [R.STORE_MANAGER]: [
    ...
    P.RETURNS_VIEW, P.RETURNS_CREATE, P.RETURNS_APPROVE, P.EXCHANGE_VIEW, P.EXCHANGE_CREATE, P.EXCHANGE_APPROVE, P.REPAIR_VIEW, P.REPAIR_CREATE, P.REPAIR_APPROVE,
  ...
  [R.SALES_MANAGER]: [
    ...
    P.RETURNS_VIEW, P.RETURNS_CREATE, P.RETURNS_APPROVE, P.EXCHANGE_VIEW, P.EXCHANGE_CREATE, P.EXCHANGE_APPROVE,
